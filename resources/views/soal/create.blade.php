                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="frm-soal">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="select2 soal-paket w-100" name="soal_paket">
                                                ...
                                                @foreach($paket as $pk)
                                                    <option value="{{ $pk->pk_id }}">{{ $pk->pk_nama }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-9">
                                            <select class="select2 soal-kategori w-100" name="soal_kategori" onchange="pilihKategori()">
                                                ...
                                                @foreach($kategori as $kt)
                                                    <option value="{{ $kt->kt_id }}">{{ $kt->kt_nama }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea name="soal" class="summernote soal"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Jawaban (A)</label>
                                        <div class="col-sm-9">
                                            <textarea name="soal_jawaban[]" class="form-control summernote soal-jawaban"></textarea>
                                            <input type="hidden" name="soal_jawaban_abjad[]" class="soal-jawaban-abjad" value="A">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Jawaban (B)</label>
                                        <div class="col-sm-9">
                                            <textarea name="soal_jawaban[]" class="form-control summernote soal-jawaban"></textarea>
                                            <input type="hidden" name="soal_jawaban_abjad[]" class="soal-jawaban-abjad" value="B">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Jawaban (C)</label>
                                        <div class="col-sm-9">
                                            <textarea name="soal_jawaban[]" class="form-control summernote soal-jawaban"></textarea>
                                            <input type="hidden" name="soal_jawaban_abjad[]" class="soal-jawaban-abjad" value="C">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Jawaban (D)</label>
                                        <div class="col-sm-9">
                                            <textarea name="soal_jawaban[]" class="form-control summernote soal-jawaban"></textarea>
                                            <input type="hidden" name="soal_jawaban_abjad[]" class="soal-jawaban-abjad" value="D">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Jawaban (E)</label>
                                        <div class="col-sm-9">
                                            <textarea name="soal_jawaban[]" class="form-control summernote soal-jawaban"></textarea>
                                            <input type="hidden" name="soal_jawaban_abjad[]" class="soal-jawaban-abjad" value="E">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Pembahasan</label>
                                        <div class="col-sm-9">
                                            <textarea name="soal_pembahasan" class="form-control summernote soal-pembahasan"></textarea>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            <div class="card-footer text-right">
                                <div class="col-lg-12 col-sm-12 col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-sm btn-success btn-simpan" onclick="storeSoal()">Simpan</button>
                                </div>
                            </div>
                        </div>
                    </div>
	                ...
	                success: function(response) {
	                    if (response.status == 'berhasil') {
	                        if (response.data.kt_tipe_soal == 'single_choice') {
	                        	...
	                        	$('.container-kunci-single').removeClass('d-none');
